    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          "ring-foreground/10 bg-popover text-popover-foreground rounded-md p-1 shadow-md ring-1 duration-100 z-50",
          "max-h-[var(--radix-dropdown-menu-content-available-height)] w-auto origin-[var(--radix-dropdown-menu-content-transform-origin)] overflow-x-hidden overflow-y-auto",
